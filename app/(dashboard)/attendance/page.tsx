...
import { Calendar as CalendarIcon, Fingerprint, PencilLine, Clock3, LogIn, LogOut, Loader2, X, ClipboardCheck } from "lucide-react";
        ...
        <div className="p-6 md:p-10 h-full overflow-y-auto custom-scrollbar">
          ...
          <header className="mb-10 text-right border-b border-black/5 pb-6 relative">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium pr-14 mt-1">جاهز للتكامل مع جهاز البصمة (BASSAMA) باستخدام employeeId</p>
              </div>

              <div className="mt-4 md:mt-0 flex flex-wrap items-end gap-4 w-full md:w-auto">
                {/* كارد التاريخ بأسلوب Glassmorphism */}
                <div className="bg-white/80 backdrop-blur-md border border-white/80 rounded-2xl p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] min-w-65 flex-1 md:flex-none hover:shadow-md transition-all group">
                      ...
                      <tr key={row.key} className="hover:bg-[#00bba7]/[0.02] transition-colors group">
                        ...
                        <td className="p-4 text-center">
                          <div className="flex items-center justify-center gap-2 opacity-80 group-hover:opacity-100 transition-opacity">
                            ...
                            >
                              {/* أنيميشن قفز لأيقونة الزر عند التمرير */}
          ...
          <div className="mt-8 bg-white/80 backdrop-blur-md p-5 rounded-[2rem] border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
            ...
            <div className="text-xs text-slate-500 font-medium flex items-center gap-2.5">
              ...
              العمليات تعتمد على <span className="font-mono bg-[#00bba7]/10 px-2 py-0.5 rounded text-[#00bba7] border border-[#00bba7]/20">employeeId</span> للتكامل مع البصمة.
            </div>
          </div>
          ...
          {timeModal.isOpen && timeModal.row && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
              <div className="bg-white rounded-4xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 duration-200 border border-white">
